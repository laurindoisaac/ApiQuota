...
#[derive(Debug)]
pub struct ApiQuotaProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ApiQuotaProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ApiQuota processing");
    
    let mut processor = ApiQuotaProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ApiQuotaProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ApiQuotaProcessor::new(false);
